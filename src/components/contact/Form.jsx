const telegramSVG = (
  <svg
    ...
    viewBox="0 0 24 24"
    className="w-4 md:w-6 h-4 md:h-6 inline-block"
    fill="currentColor"
  >
    <path
...
const commonClass =
  "input input-lg border-0 border-b-2 bg-white text-[#061049] \
   placeholder:text-[#8a94b3] focus:placeholder:text-[#061049] \
   focus:outline-none focus:border-[#061049] \
   border-b-[#E6E8EB] w-full rounded-none px-0";
  ...
  return (
    <div className="mx-2">
      <form className="flex flex-col gap-4 mt-2">
        ...
        <input type="text" placeholder="Message*" className={commonClass + " h-32 resize-none"} required />
        <button
          type="submit"
          className="btn gap-2 max-lg:mx-auto bg-[#061049] text-white rounded-sm mt-4 text-[13px] md:text-[16px] w-fit font-semibold px-4 py-2 flex items-center"
        >
          Submit {telegramSVG}
        </button>
      </form>
