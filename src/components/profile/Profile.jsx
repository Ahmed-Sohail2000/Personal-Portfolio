      ...
      <div className="flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold mb-6 leading-snug text-[#001f3f]">
            AI Engineer | LLMs, AI Agents & Applied Intelligent Systems
          </h2>
        
          <div className="text-sm sm:text-base lg:text-lg text-gray-600 space-y-4">
            <p>
            ...
            <p>
              I develop AI agents, retrieval-augmented generation (RAG) pipelines, and end-to-end machine learning workflows—
              from data preparation and model training to deployment and production monitoring.
            </p>

            {/* Background */}
            <p className="text-gray-500">
              <span className="font-medium text-gray-600">Background:</span> I hold a Bachelor’s degree in Electrical Engineering
              and an associate-level Project Management certification (CAPM), with hands-on experience in the solar energy sector.
              This foundation allows me to build AI systems with a strong engineering mindset and real-world deployment focus.
            </p>
          </div>
